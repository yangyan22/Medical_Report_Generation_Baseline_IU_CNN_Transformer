...
def parse_agrs():
    ...
    # # Data input settings
    parser.add_argument('--image_dir', type=str, default='/public/home/yangyan/YangYan/IU_Y',
                        help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default='/public/home/yangyan/YangYan/R2_mesh_token.json',
                        help='the path to the directory containing the data.')

    # parser.add_argument('--image_dir', type=str, default='/media/camlab1/doc_drive/IU_data/IU_Y',
    #                     help='the path to the directory containing the data.')
    # parser.add_argument('--ann_path', type=str, default='/media/camlab1/doc_drive/IU_data/R2/R2_mesh_token.json',
    #                     help='the path to the directory containing the data.')
    ...
    parser.add_argument('--visual_extractor', type=str, default='resnet50', help='the visual extractor to be used.')  # resnet18 resnet50 resnet101 densenet121
    parser.add_argument('--visual_extractor_pretrained', type=bool, default=True, help='the pretrained visual extractor')
    ...
    parser.add_argument('--n_gpu', type=int, default=2, help='the sample number per image.')
    ...
    parser.add_argument('--restore_dir', type=str, default='./results/DensNet121_TD_L6_IU_Y/')
